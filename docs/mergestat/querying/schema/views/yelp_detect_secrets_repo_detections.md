---
sidebar_position: 7
description: Schema for the MergeStat yelp_detect_secrets_repo_detections view.
---

# yelp_detect_secrets_repo_detections

```sql
CREATE VIEW yelp_detect_secrets_repo_detections AS  SELECT yelp_detect_secrets_repo_scans.repo_id,
